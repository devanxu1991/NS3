...
int main (int argc, char *argv[])
{
  ...
  std::ofstream berfile ("exp3-802.15.4-psr-distance.plt");
  ...
  Gnuplot psrplot = Gnuplot ("exp3-802.15.4-psr-distance.eps");
  Gnuplot2dDataset psrdataset ("exp3-802.15.4-psr-vs-distance");
